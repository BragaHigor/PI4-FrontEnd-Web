            ...
            return (
               <div className={style.parentContainer} key={id}>
                  <Card
                     ...
                     curtoseHora={
                        data.hours.statistic[0]?.[card.value].kurtosis
                     }
                     desvioPadraoHora={
                        data.hours.statistic[0]?.[card.value].standardDeviation
                     }
                     assimetriaHora={
                        data.hours.statistic[0]?.[card.value].skewness
                     }
                     probabilidadeHora={
                        data.hours.statistic[0].hydrationProbability || 0
                     }
                     ...
                     desvioPadraoDia={
                        data.days.statistic[5]?.[card.value].standardDeviation
                     }
                     assimetriaDia={
                        data.days.statistic[5]?.[card.value].skewness
                     }
                     probabilidadeDia={
                        data.days.statistic[5].hydrationProbability || 0
                     }
                  />
               </div>
            );
